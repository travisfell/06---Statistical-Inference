...
sp4 <- ((.6^2 * 9 + .68^2 * 9)/(18))
#(3-5) + c(-1,1) * qt(.975, 18) * sp4 * (1/10 + 1/10)^.5
(3-5) + c(-1,1) * qt(.975, 18) * (.6/10 + .68/10)^.5

#question 6
sp6 <- sqrt((99 * .5^2 + 99 * 2^2)/(200-2))
6-4 + c(-1,1) * qt(.975, 198)* sp6 * (1/99 + 1/99)^.5
6-4 + c(-1,1) * qt(.975, 198)* (.5^2/100 * 2^2/100)^.5

#question 7
# find pooled std
# see vid 08 03 around 3 min
#sp7 <- sqrt((8 * 1.5^2 + 8 * 1.8^2)/(16))
sp7 <- (1.5^2 + 1.8^2)/2
-3 - 1 + c(-1,1) * qt(.975, 17) * sp7/sqrt(18)
